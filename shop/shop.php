...
<body>
    ...
    <div class="banner">
        <div class="banner-content">
            ...
            <p>Up to <span class="highlight">70% Off</span> - All T-Shirts & Accessories</p>
    ...
    <div class="container">
        ...
        <div class="cards">
            ...
            <div class="card">
                <img src="../images/n1.jpg" alt="Product 1">
                <p class="brand">adidas</p>
                <p class="product-name">Cartoon Astronaut T-Shirts</p>
                <div class="rating">
                    ★★★★☆
            ...
            <div class="card">
                <img src="../images/n2.jpg" alt="Product 2">
                <p class="brand">adidas</p>
                <p class="product-name">Cartoon Astronaut T-Shirts</p>
                <div class="rating">
                    ★★★★☆
            ...
            <div class="card">
                <img src="../images/n3.jpg" alt="Product 3">
                <p class="brand">adidas</p>
                <p class="product-name">Cartoon Astronaut T-Shirts</p>
                <div class="rating">
                    ★★★★☆
            ...
            <div class="card">
                <img src="../images/n4.jpg" alt="Product 4">
                <p class="brand">adidas</p>
                <p class="product-name">Cartoon Astronaut T-Shirts</p>
                <div class="rating">
                    ★★★★☆
            ...
            <div class="card">
                <img src="../images/n5.jpg" alt="Product 5">
                <p class="brand">adidas</p>
                <p class="product-name">Cartoon Astronaut T-Shirts</p>
                <div class="rating">
                    ★★★★☆
            ...
            <div class="card">
                <img src="../images/n6.jpg" alt="Product 6">
                <p class="brand">adidas</p>
                <p class="product-name">Cartoon Astronaut T-Shirts</p>
                <div class="rating">
                    ★★★★☆
            ...
            <div class="card">
                <img src="../images/n7.jpg" alt="Product 7">
                <p class="brand">adidas</p>
                <p class="product-name">Cartoon Astronaut T-Shirts</p>
                <div class="rating">
                    ★★★★☆
            ...
            <div class="card">
                <img src="../images/n8.jpg" alt="Product 8">
                <p class="brand">adidas</p>
                <p class="product-name">Cartoon Astronaut T-Shirts</p>
                <div class="rating">
                    ★★★★☆
